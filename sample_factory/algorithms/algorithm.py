...
class AlgorithmBase:
    ...
    def add_cli_args(cls, parser):
        ...
        p.add_argument('--reward_dir', default="['train_dir/reward_saving_dir/aggressive_v1']", type=str, help='Root dir to load reward model from.')
        p.add_argument('--load_optim', default=False, type=str2bool, help='To load or not the pretrained optimizer.')
...
class ReinforcementLearningAlgorithm(AlgorithmBase, ABC):
    ...
    def add_cli_args(cls, parser):
        ...
        p.add_argument('--msg_max_keys', type=int, default=20, help='How many messages should we keep in the messages dictionary.')
        p.add_argument('--option_msg_reset', type=str2bool, default=False, help='To reset or not options messages every termination.')
        p.add_argument('--meta_policy_id', type=str, default='option_v1', help='What function to call for the meta policy')
        p.add_argument('--penalty_mode', type=str, default='none', help='The type of time penalty to add to the reward')
